...
<script>
	$(function () {
		...
		function bannerwave1() {
			$("#banner_bolang_bg_1").css({"left": "-236px"}).animate({"left": "-1233px"}, 25000, 'linear', bannerwave1);
		}
		function bannerwave2() {
			$("#banner_bolang_bg_2").css({"left": "0px"}).animate({"left": "-1009px"}, 60000, 'linear', bannerwave2);
		}
		//循环播放
